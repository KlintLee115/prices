...
pricesRouter.get('/getUserInfo', (req: Request, res: Response) => {
...
pricesRouter.get('/getPosts', (req: Request, res: Response) => {
...
pricesRouter.get('/getPricesData', (req: Request, res: Response) => {
...
pricesRouter.post('/insertNewPrice', (req: Request, res: Response) => {
...
pricesRouter.post('/getUserFeedbacks', async (req, res) => {
    try {
...
pricesRouter.patch('/feedback', async (req, res) => {
